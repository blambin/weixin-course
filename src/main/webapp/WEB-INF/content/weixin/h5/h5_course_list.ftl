...
<div class="tabbar tabbar_wrap page_wrap">
    <div class="weui_tab">
        ...
        <header class="m-header z-img-ready border-top">
            <div class="header_search">
                <div class="u-search">
                    ...
                    <input type="text" id="searchInput" class="search_input z-abled" value="${name!''}" autocorrect="off" placeholder="输入课程名称进行查找">
                </div>
            </div>
        </header>
        <!-- /顶部搜索框 -->
        ...
        <script type="text/javascript">
            var ajaxUrl   = BASE_PATH + "/weixin/h5/queryCourseListJson.do?1=1";
            var lessonUrl = BASE_PATH + "/weixin/h5/queryCourseDetail.do?1=1";
            var keywords = $.trim($("#searchInput").val());
            $(function () {
                var i = 1; //设置当前页数，全局变量
        ...
        <div class="weui_tabbar ">
            ...
            <a href="${contextPath!}/weixin/h5/queryCourseList.do?1=1" class="weui_tabbar_item weui_bar_item_on">
                <div class="weui_tabbar_icon">
